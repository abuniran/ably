...
function getCartItems() {
  ...
  items_in_cart.innerHTML = itms_c;

  price_cart_Head.innerHTML = "دينار" + total_price;
  count_item.innerHTML = product_cart.length;

  count_item_cart.innerHTML = `( دينار${product_cart.length}عنصر في عربة التسوّق)`;
  price_cart_total.innerHTML = "دينار" + total_price;
}
